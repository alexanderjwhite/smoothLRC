...
sce_seurat <- CreateSeuratObject(assay(sce))
...
Lastly, we can visualize these features with a heatmap.

```{r Differential Expression Part 2, fig.height=5, fig.width=5.5, message=FALSE, warning=FALSE}
library(NMF)
